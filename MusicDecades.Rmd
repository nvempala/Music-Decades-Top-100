...
To replicate the results below in R, first download the dataset with the decades data tited "NVDecades.csv". Then make sure to set your working directory in R to the folder containing this dataset, or mention the full/absolute path of the file in the read.csv function.
